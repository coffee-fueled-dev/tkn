...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Download 1000 stories to small sample (saved to .corpus/small_sample.txt)
  python3 download_stories.py 1000 -o small_sample.txt

  # Download 50k stories to medium sample (saved to .corpus/medium_sample.txt)
  ...
  python3 download_stories.py 1000 -o ../custom_location.txt
    ...
    parser.add_argument(
        "-o", "--output",
        type=str,
        help="Output filename (default: tinystories_<num>_stories.txt in .corpus/ directory)"
    )
    parser.add_argument(
        "--start-index",
        type=int,
