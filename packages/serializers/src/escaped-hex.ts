/**
 * Convert a Uint8Array or number[] into a SQL literal escaped string.
 *
 * Example: [188, 189, 186, 170] =>
 *   "\\xBC\\xBD\\xBA\\xAA"
 */
export function escapedHex(input: Uint8Array | number[]): string {
...
// inverse of escapedHex: turns "\\xBC\\xBD..." -> [188, 189, ...]
export function bytesFromEscapedHex(s: string): number[] {
  const out: number[] = [];
